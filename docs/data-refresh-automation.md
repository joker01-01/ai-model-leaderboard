...
- Full-snapshot refresh run [`34002452998`](https://github.com/joker01-01/ai-model-leaderboard/actions/runs/34002452998) updated [PR #18](https://github.com/joker01-01/ai-model-leaderboard/pull/18) from current `main` with 643 unique public rows and complete four-page pagination. Its [`verify` run](https://github.com/joker01-01/ai-model-leaderboard/actions/runs/34002517870) passed. Trusted policy run [`34002569376`](https://github.com/joker01-01/ai-model-leaderboard/actions/runs/34002569376) correctly retained the PR for human review because Intelligence changed from version 4.1 to 4.2, Agentic finite coverage fell from 197 to 100, and legacy compatibility membership changed. This is an expected fail-closed result, not an automation failure.
