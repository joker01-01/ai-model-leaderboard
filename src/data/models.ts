...
export interface ModelSource { label: string; url: string }

export interface Model {
  id: string;
  name: string;
  maker: string; makerEn: string;
...
export const MODELS: Model[] = [
  ...
  },
  {
    ...
    maker: "Anthropic", makerEn: "Anthropic", country: "美国", flag: "🇺🇸",
    release: "2026-08", ctx: null, priceTier: "极高",
    priceNote: "公开 API 中最高一档",
    open: false, license: "闭源",
    badges: ["AA 综合榜 #1"],
  ...
  },
  {
    id: "gpt-56-sol",
    name: "GPT-5.6 Sol",
    maker: "OpenAI", makerEn: "OpenAI", country: "美国", flag: "🇺🇸",
    release: "2026-08", ctx: null, priceTier: "高",
    priceNote: "旗舰档定价",
    open: false, license: "闭源",
    badges: ["GPT-5.6 旗舰", "AA 全球前三"],
    ...
    sources: [
      ...
      { label: "Grok 4.6 与 Sol 并列全球第三", url: "https://venturebeat.com/technology/spacexai-debuts-grok-4-6-overtaking-kimi-k3s-performance-and-matching-gpt-5-6-sol-for-worlds-third-best-on-artificial-analysis" },
    ],
  },
  {
    id: "gpt-56-luna",
    name: "GPT-5.6 Luna",
    maker: "OpenAI", makerEn: "OpenAI", country: "美国", flag: "🇺🇸",
    release: "2026-08", ctx: null, priceTier: "低",
    priceNote: "ChatGPT 免费用户默认模型",
    open: false, license: "闭源",
    badges: ["免费默认", "ChatGPT 生态"],
  ...
  },
  {
    ...
    maker: "Google", makerEn: "Google DeepMind", country: "美国", flag: "🇺🇸",
    release: "2026-08", ctx: null, priceTier: "低",
    priceNote: "Flash 档定价，免费生态可及",
    open: false, license: "闭源",
    badges: ["低延迟", "编程强"],
  ...
  },
  {
    ...
    maker: "阿里巴巴", makerEn: "Alibaba", country: "中国", flag: "🇨🇳",
    release: "2026-02-16", ctx: null, priceTier: "低",
    priceNote: "权重开源可商用，API 平价",
    open: true, license: "Apache-2.0",
    badges: ["开源", "397B-A17B", "工具调用"],
    ...
    sources: [
      ...
      { label: "千问 3.5 开源报道", url: "https://www.stdaily.com/web/gdxw/2026-02/16/content_474848.html" },
    ],
  },
  {
    id: "deepseek-v4",
    name: "DeepSeek V4（开源）",
    maker: "深度求索", makerEn: "DeepSeek", country: "中国", flag: "🇨🇳",
    release: "2026-04", ctx: "1M", priceTier: "自部署",
    priceNote: "权重 MIT 开源免费商用，仅硬件成本",
    open: true, license: "MIT",
    badges: ["开源", "百万上下文"],
  ...
  },
  {
    ...
    maker: "Anthropic", makerEn: "Anthropic", country: "美国", flag: "🇺🇸",
    release: "2026-08", ctx: null, priceTier: "中",
    priceNote: "与上代同价升级",
    open: false, license: "闭源",
    badges: ["同价升级", "编程提升"],
  ...
  },
  {
    id: "grok-4-6",
    name: "Grok 4.6",
    maker: "SpaceXAI", makerEn: "SpaceXAI (xAI)", country: "美国", flag: "🇺🇸",
    release: "2026-07", ctx: null, priceTier: "中",
    priceNote: "主流定价，生态内可用",
    open: false, license: "闭源",
    badges: ["AA 全球前三", "长流程任务"],
  ...
  },
  {
    id: "kimi-k3",
    name: "Kimi K3",
    maker: "月之暗面", makerEn: "Moonshot AI", country: "中国", flag: "🇨🇳",
    release: "2026-08", ctx: null, priceTier: "低",
    priceNote: "平价 API",
    open: true, license: "Kimi K3 License",
    badges: ["开放权重", "曾居 AA 第三", "长文本"],
    blurb: "开放权重的中文与长文本旗舰；一度登顶 AA 全球第三，被 Grok 4.6 追平后仍稳居第一梯队。",
    strengths: ["Kimi K3 License 开放权重", "中文/长文本", "推理扎实"],
    weaknesses: ["国际生态弱", "自部署门槛高"],
    sources: [
      { label: "Moonshot AI：Kimi K3 官方仓库", url: "https://github.com/MoonshotAI/Kimi-K3" },
      { label: "Kimi K3 License", url: "https://github.com/MoonshotAI/Kimi-K3/blob/main/LICENSE" },
  ...
  },
  {
    ...
    name: "Gemini 3.1 Pro",
    maker: "Google", makerEn: "Google DeepMind", country: "美国", flag: "🇺🇸",
    release: "2026-02", ctx: null, priceTier: "中",
    priceNote: "Pro 档定价",
    open: false, license: "闭源",
    badges: ["多模态"],
  ...
  },
  {
    id: "minimax-m3",
    name: "MiniMax M3",
    maker: "MiniMax", makerEn: "MiniMax", country: "中国", flag: "🇨🇳",
    release: "2026 上半年", ctx: "1M", priceTier: "低",
    priceNote: "平价 API",
    open: false, license: "闭源 API",
    badges: ["1M 上下文", "原生多模态"],
  ...
  },
  {
    ...
    maker: "深度求索", makerEn: "DeepSeek", country: "中国", flag: "🇨🇳",
    release: "2026-08-04", ctx: "1M", priceTier: "低",
    priceNote: "极低成本接入",
    open: true, license: "MIT",
    badges: ["开源", "百万上下文"],
  ...
  },
  {
    id: "motif-3",
    name: "Motif 3",
    maker: "Dokpamo", makerEn: "Dokpamo", country: "韩国", flag: "🇰🇷",
    release: "2026-08", ctx: null, priceTier: "中",
    priceNote: "开源权重 + 平价 API",
  ...
  },
  {
    id: "doubao-2-1-pro",
    name: "Doubao 2.1 Pro",
    maker: "字节跳动", makerEn: "ByteDance", country: "中国", flag: "🇨🇳",
    release: "2026-06", ctx: null, priceTier: "低",
    priceNote: "平价 API，产品生态内可用",
    open: false, license: "闭源 API",
    badges: ["多模态生态"],
  ...
  },
  {
    ...
    maker: "Mistral AI", makerEn: "Mistral AI", country: "法国", flag: "🇫🇷",
    release: "2025-09", ctx: null, priceTier: "中",
    priceNote: "主流定价，权重开放",
    open: true, license: "Apache-2.0",
    badges: ["欧洲开源代表"],
