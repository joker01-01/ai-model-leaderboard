...
export const MODELS: Model[] = [
  ...
  },
  {
    ...
    badges: ["开源", "Agentic"],
    blurb: "Agentic 定位的开源旗舰，国内生态最全；权重开源、可商用。",
    strengths: ["Apache 开源可商用", "Agentic 能力与生态"],
  ...
  },
  {
    ...
    open: false, license: "闭源",
    badges: ["多智能体"],
    blurb: "SpaceXAI 多智能体版，多 Agent 协同与视频工作流见长。",
