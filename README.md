...
编辑推荐榜保留六个维度：综合智能、编程、工具使用、推理·数学、性价比和开源。你可以直接使用预设，也可以调整权重，比较不同偏好下的排序变化。页面还会自动标出“当前推荐候选”：取当前偏好前 5 与同版本 AA 智能指数前 3 的并集，因此像 Claude Fable 5、GPT-5.6 Sol 这样的新模型会随着最新公开快照进入候选，不需要手工维护一份固定推荐名单。
